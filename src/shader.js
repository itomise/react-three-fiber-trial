export const shader = {
  vertexShader: `
    ...
    void main() {
      ...
      float speed = 2.6;
      float noise = snoise(normal * noiseScale + u_time * noiseSpeed) * 100.0;
      //float smoothNoise = smoothstep(0.1, 0.9, noise);
      vec3 noiseNormal = normal * noise;
      vec3 c = position + noiseNormal;
